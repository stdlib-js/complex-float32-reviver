...
```javascript
reviveComplex64 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-reviver@v0.0.3-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-reviver@v0.0.3-umd/browser.js"></script>
```
